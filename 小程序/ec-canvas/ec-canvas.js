  ...
  methods: {
    ...
    initByNewWay(callback) {
      ...
      query
        ...
        .exec(res => {
          // ✅ 新增：安全检查（防弹衣）
          // 如果节点还没渲染出来，res[0] 会是 null，这里直接停止，防止报错崩溃
          if (!res || !res[0] || !res[0].node) {
             console.warn('Canvas 节点未准备好，跳过本次初始化');
             return;
          }
          ...
          // 修复 2: 获取 pixelRatio，优先使用 wx.getWindowInfo()
          // 旧代码: const canvasDpr = wx.getSystemInfoSync().pixelRatio
